...
Most of this documentation is presented as GIF walkthroughs. If something is unclear, don't hesitate to [submit an issue on GitHub](https://github.com/Gopendranath/full-calendar-plus/issues) or comment on an existing one.
